...
try {
    ...
    $sqlBancos = "
        SELECT 
            ...
            CAST(CASE WHEN m.Origen = 'AJUSTE' THEN 1 ELSE 0 END AS INT) AS EsAjusteManual
        FROM Tbl_Transacciones_Maestra m
        ...
        SELECT 
            ...
            CAST(MAX(CASE WHEN m.Origen = 'AJUSTE' THEN 1 ELSE 0 END) AS INT) AS EsAjusteManual
        FROM Tbl_Transacciones_Maestra m
